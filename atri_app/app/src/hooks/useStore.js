...
const desktopModeProps = {
  ...
  "Home": {
    ...
    "TextBox52": {
      "custom": {
        "text": "Applications I'm fluent in Every designer needs the right tools to do the perfect job. Thankfully, I'm multilingual.  Sketch Webflow Figma"
      },
      "callbacks": {
        "onClick": [
          {
    ...
    "TextBox53": {
      "custom": {
        "text": "What you can expect I design products that are more than pretty. I make them shippable and usable.  Clean and functional Device and user friendly Efficient and maintainable"
      },
      "callbacks": {
        "onClick": [
          {
